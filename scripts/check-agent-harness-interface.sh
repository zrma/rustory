...
grep -Fq -- '<!-- Generated by ai-first 1.0.0.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.0.0.' docs/agent-harness.md ||
...
grep -Fq -- '"source_revision": "v1.0.0"' .ai-first.lock ||
  fail "framework release tag is missing from lock"
grep -Fq -- '"source_commit": "cd20e4078fad541440a03b63a33ebe328427fcce"' .ai-first.lock ||
