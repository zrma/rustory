...
grep -Fq -- '<!-- Generated by ai-first 1.6.0.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.6.0.' docs/agent-harness.md ||
...
grep -Fq -- '"source_revision": "v1.6.0"' .ai-first.lock ||
  fail "framework release tag is missing from lock"
grep -Fq -- '"source_commit": "c6da34456412cb7956b5f0d03011500664f25fca"' .ai-first.lock ||
