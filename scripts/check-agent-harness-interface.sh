...
grep -Fq -- '<!-- Generated by ai-first 1.5.0.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.5.0.' docs/agent-harness.md ||
...
grep -Fq -- '"source_revision": "v1.5.0"' .ai-first.lock ||
  fail "framework release tag is missing from lock"
grep -Fq -- '"source_commit": "471141d41882f829c8f9852f83933c47dee9e59d"' .ai-first.lock ||
