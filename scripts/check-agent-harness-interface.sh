...
grep -Fq -- '<!-- Generated by ai-first 1.3.1.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.3.1.' docs/agent-harness.md ||
...
grep -Fq -- '"source_revision": "v1.3.1"' .ai-first.lock ||
  fail "framework release tag is missing from lock"
grep -Fq -- '"source_commit": "c5af8a9bc23bb36def22d19657bbffec806889fd"' .ai-first.lock ||
